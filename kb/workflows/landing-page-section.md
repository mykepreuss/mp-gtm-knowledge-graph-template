...
links:
  ...
  - rel: DEPENDS_ON
    href: "[[kb/templates/landing-page-section]]"
  - rel: DEPENDS_ON
    href: "[[kb/rubrics/landing-page-section]]"
---
...
- Risky claims -> tighten `kb/canon/trust-boundaries.md`.
- ICP drift -> tighten `kb/canon/icp.md`.
