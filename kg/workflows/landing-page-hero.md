...
links:
  ...
  - rel: DEPENDS_ON
    href: "[[kg/templates/landing-page-hero]]"
  - rel: DEPENDS_ON
...
- If risky claims keep appearing: tighten `kg/canon/trust-boundaries.md`.
- If it’s not ICP-specific: tighten `kg/canon/icp.md`.
